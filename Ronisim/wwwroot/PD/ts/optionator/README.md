...
Optionator is a JavaScript option parsing and help generation library used by [eslint](https://eslint.org), [Grasp](https://graspjs.com), [LiveScript](https://livescript.net), [esmangle](https://github.com/estools/esmangle), [escodegen](https://github.com/estools/escodegen), and [many more](https://www.npmjs.com/browse/depended/optionator).

For an online demo, check out the [Grasp online demo](https://www.graspjs.com/#demo).
...
## Technical About
`optionator` is written in [LiveScript](https://livescript.net/) - a language that compiles to JavaScript. It uses [levn](https://github.com/gkz/levn) to cast arguments to their specified type, and uses [type-check](https://github.com/gkz/type-check) to validate values. It also uses the [prelude.ls](https://preludels.com/) library.
