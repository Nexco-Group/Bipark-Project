/*!
 * Remark Material (https://getbootstrapadmin.com/remark)
...
! function (global, factory) {
    ...
    if (window.localStorage) {
        var getLevel = function (url, tag) {
            ...
            settings = localStorage.getItem("remark.material.topbar.skinTools");
        if (settings) {
        ...
        document.addEventListener && document.addEventListener("DOMContentLoaded", function () {
            ...
            ({
                ...
                storageKey: "remark.material.topbar.skinTools",
                defaultSettings: {
                    sidebar: "dark",
                    navbar: "orange",
                    navbarInverse: "true",
                ...
                init: function () {
                    var self = this;
                    this.path = getLevel(window.location.pathname, "topbar"), this.overflow = !1, this.$siteSidebar = $(".site-menubar"), this.$siteNavbar = $(".site-navbar"), this.$container = $(this.tpl), this.$toggle = $(".site-skintools-toggle", this.$container), this.$content = $(".site-skintools-content", this.$container), this.$tabContent = $(".tab-content", this.$container), this.$sidebar = $("#skintoolsSidebar", this.$content), this.$navbar = $("#skintoolsNavbar", this.$content), this.$primary = $("#skintoolsPrimary", this.$content), this.build(this.$sidebar, this.skintoolsSidebar, "skintoolsSidebar", "radio", "Sidebar Skins"), this.build(this.$navbar, this.skintoolsNavbar, "skintoolsNavbar", "radio", "Navbar Skins"), this.build(this.$primary, this.skintoolsPrimary, "skintoolsPrimary", "radio", "Primary Skins"), this.$container.appendTo($body), this.$toggle.on("click", function () {
