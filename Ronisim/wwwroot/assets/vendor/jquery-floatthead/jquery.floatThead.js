// @preserve jQuery.floatThead 1.3.1 - https://mkoryak.github.io/floatThead/ - Copyright (c) 2012 - 2015 Misha Koryak
// @license MIT
  ...
  $.fn.floatThead = function(map){
    ...
    if(opts.debug){
      ...
      if(parseInt(v[0], 10) == 1 && parseInt(v[1], 10) <= 7){
        debug("jQuery version "+$.fn.jquery+" detected! This plugin supports 1.8 or better, or 1.7.x with jQuery UI 1.8.24 -> https://jqueryui.com/resources/download/jquery-ui-1.8.24.zip")
      }
    }
    ...
    this.filter(':not(.'+opts.floatTableClass+')').each(function(){
      ...
      if(typeof opts.useAbsolutePositioning !== 'undefined'){
        ...
        debug("option 'useAbsolutePositioning' has been removed in v1.3.0, use `position:'"+opts.position+"'` instead. See docs for more info: https://mkoryak.github.io/floatThead/#options")
      }
      if(typeof opts.scrollingTop !== 'undefined'){
        opts.top = opts.scrollingTop;
        debug("option 'scrollingTop' has been renamed to 'top' in v1.3.0. See docs for more info: https://mkoryak.github.io/floatThead/#options");
      }
      if(typeof opts.scrollingBottom !== 'undefined'){
          opts.bottom = opts.scrollingBottom;
          debug("option 'scrollingBottom' has been renamed to 'bottom' in v1.3.0. See docs for more info: https://mkoryak.github.io/floatThead/#options");
      }
...
/* jQuery.floatThead.utils - https://mkoryak.github.io/floatThead/ - Copyright (c) 2012 - 2014 Misha Koryak
 * License: MIT
 *
