...
(function () {
  ...
  angular.module('ui.grid').constant('uiGridConstants', {
    ...
    // copied from https://www.lsauer.com/2011/08/javascript-keymap-keycodes-in-json.html
    keymap: {
      TAB: 9,
      STRG: 17,
      CTRL: 17,
...
module.service('gridUtil', ['$log', '$window', '$document', '$http', '$templateCache', '$timeout', '$injector', '$q', '$interpolate', 'uiGridConstants',
  ...
  var s = {
     ...
     *
     * See https://alistapart.com/article/getoutbindingsituations
     *
     */
  ...
  /**
    ...
    */
    ...
    // Thanks to https://stackoverflow.com/a/13382873/888165
  ...
  // https://stackoverflow.com/a/24107550/888165
  ...
  // https://stackoverflow.com/a/22948274/888165
  // TODO: Opera? Mobile?
